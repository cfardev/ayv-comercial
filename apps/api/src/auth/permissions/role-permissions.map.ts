...
export const ROLE_PERMISSIONS: Record<UserRole, PermissionKey[]> = {
	...
	[UserRole.SELLER]: [
		...
		PERMISSION_KEYS.CUSTOMERS_DEACTIVATE,
		PERMISSION_KEYS.CUSTOMERS_REACTIVATE,
		PERMISSION_KEYS.INVENTORY_STOCK_READ,
	],
	...
	[UserRole.DISPATCH_MANAGER]: [PERMISSION_KEYS.INVENTORY_STOCK_READ],
