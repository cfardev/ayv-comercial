...
- .agents/skills
- /home/cfardev/.agents/skills
- /home/cfardev/.config/opencode/skills
- /home/cfardev/.copilot/skills
...
### branch-pr
- Path: /home/cfardev/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /home/cfardev/.config/opencode/skills/chained-pr/SKILL.md
...
- Path: /home/cfardev/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/cfardev/.config/opencode/skills/comment-writer/SKILL.md
...
### cu-create
- Path: /home/cfardev/personal/ayv-comercial/.agents/skills/cu-create/SKILL.md
- Trigger: Create a new use case (CU) file for the ayv-comercial backoffice. Detects the next CU number, scaffolds the file with the standard structure including the "## Implementación técnica" section, updates ROADMAP.md, and warns about dependency overlaps with existing CUs.
- Rules:
...
### cu-delete
- Path: /home/cfardev/personal/ayv-comercial/.agents/skills/cu-delete/SKILL.md
- Trigger: Delete an existing use case (CU) file for the ayv-comercial backoffice. Checks for dependents (CUs that list the target as a dependency) and prompts for developer approval before proceeding. After deletion, removes the CU row from ROADMAP.md and renumbers the dev-order column.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### cu-edit
- Path: /home/cfardev/personal/ayv-comercial/.agents/skills/cu-edit/SKILL.md
- Trigger: Edit an existing use case (CU) file for the ayv-comercial backoffice. Add, remove, or update any section or implementation task. After changes, syncs ROADMAP.md status automatically — marks the CU as complete if all tasks are checked, or reverts to pending/in-progress if unchecked tasks remain.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### cu-next
- Path: /home/cfardev/personal/ayv-comercial/.agents/skills/cu-next/SKILL.md
- Trigger: Identifies the next use case (CU) ready to be implemented by checking ROADMAP.md for pending CUs whose dependencies are all complete. Also surfaces any incomplete checkboxes from in-progress CUs.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### cu-start
- Path: /home/cfardev/personal/ayv-comercial/.agents/skills/cu-start/SKILL.md
- Trigger: Begins implementation of a specific use case. Sets ROADMAP.md status to in-progress, creates a git branch, and implements each checkbox in the "## Implementación técnica" section sequentially. Never marks ROADMAP as complete; completion is handled only after cu-verify and explicit user confirmation.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### cu-verify
- Path: /home/cfardev/personal/ayv-comercial/.agents/skills/cu-verify/SKILL.md
- Trigger: Verifies that all implementation checkboxes for a given use case (CU) are actually implemented in the codebase. Scans code for each task, reports gaps, and only after explicit user confirmation performs git add/commit/push and marks ROADMAP complete.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### find-skills
- Path: /home/cfardev/.agents/skills/find-skills/SKILL.md
...
### go-testing
- Path: /home/cfardev/.config/opencode/skills/go-testing/SKILL.md
...
### interface-design
- Path: /home/cfardev/personal/ayv-comercial/.agents/skills/interface-design/SKILL.md
...
### issue-creation
- Path: /home/cfardev/.config/opencode/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /home/cfardev/.config/opencode/skills/judgment-day/SKILL.md
...
- Path: /home/cfardev/personal/ayv-comercial/.agents/skills/nestjs-best-practices/SKILL.md
...
### prisma-expert
- Path: /home/cfardev/personal/ayv-comercial/.agents/skills/prisma-expert/SKILL.md
- Trigger: You are an expert in Prisma ORM with deep knowledge of schema design, migrations, query optimization, relations modeling, and database operations across PostgreSQL, MySQL, and SQLite.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### shadcn
- Path: /home/cfardev/personal/ayv-comercial/.agents/skills/shadcn/SKILL.md
...
### skill-creator
- Path: /home/cfardev/.config/opencode/skills/skill-creator/SKILL.md
...
### tanstack-query
- Path: /home/cfardev/personal/ayv-comercial/.agents/skills/tanstack-query/SKILL.md
- Trigger: Powerful asynchronous state management, server-state utilities, and data fetching for TS/JS, React, Vue, Solid, Svelte & Angular.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### turborepo
- Path: /home/cfardev/personal/ayv-comercial/.agents/skills/turborepo/SKILL.md
- Trigger: |
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### upload-thing
- Path: /home/cfardev/personal/ayv-comercial/.agents/skills/upload-thing/SKILL.md
- Trigger: Integrates UploadThing for browser uploads with a split React (Vite) client and Express/NestJS API—file routers, createRouteHandler, typed React helpers, url/headers for presigned requests, CORS, and UPLOADTHING_TOKEN. Use when adding UploadThing, @uploadthing/react, file uploads, image uploaders, or UploadThing middleware.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### vitest
- Path: /home/cfardev/personal/ayv-comercial/.agents/skills/vitest/SKILL.md
...
### work-unit-commits
- Path: /home/cfardev/.config/opencode/skills/work-unit-commits/SKILL.md
